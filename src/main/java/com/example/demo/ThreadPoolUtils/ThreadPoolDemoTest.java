...
public class ThreadPoolDemoTest {
        ...
        private static ThreadPoolExecutor threadpool =new ThreadPoolExecutor(2, 10, 20, TimeUnit.SECONDS, new ArrayBlockingQueue(10),
        ...
        public static void main(String[] args) {
            ThreadPoolDemoTest t = new ThreadPoolDemoTest();
            for (int i = 0; i < 20; i++) {
